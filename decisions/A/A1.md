...
Every other decision in this repository exists to make this true.
...
- Every non-core decision must have parents, and every artifact must cite a decision, or the radius cannot be computed.
