---
id: B31
title: "The outbox is the human-to-agent channel: outbox notes, action tags, hand-typed ratified_by"
status: active
parents: ["[[A6]]", "[[A3]]", "[[A7]]"]
supersedes: []
superseded_by:
...
- 2026-09-18 title changed from "The outbox is the human-to-agent channel: notes in decisions/outbox, action tags, typed-in ratified_by" by Claude Fable 5.1.
